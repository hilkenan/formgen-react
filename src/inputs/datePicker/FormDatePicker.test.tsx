...
describe('FormDatePicker Unit Tests', () => {
  ...
  describe('Renders for combinations of props', () => {
    ...
    it('With initial value', () => {
      let result: any;
      let inDate = moment.utc("2018-03-11T00:00:00.000Z");
      renderedForm = ReactTestUtils.renderIntoDocument(
        <Form jsonFormData={ jsonForm }
  ...
  describe('DatePicker update tests', () => {
    it('DatePicker is updating', () => {
      let result: any;
      let updateStub: sinon.SinonStub = sinon.stub();
      let inDate = moment.utc("2018-03-12T00:00:00.000Z");
      ...
      let datePicker: FormDatePicker = ReactTestUtils.findRenderedComponentWithType(renderedForm, FormDatePicker);
  ...
  describe('DatePicker validate tests', () => {
    it('DatePicker is validating', () => {
