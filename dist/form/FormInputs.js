...
var FormInputs = /** @class */ (function () {
    function FormInputs() {
        ...
        */
        this.controls = [
            { typeName: Enums_1.ControlTypes.Tab, controlType: Tab_1.Tab },
            { typeName: Enums_1.ControlTypes.TabContainer, controlType: TabContainer_1.TabContainer },
            { typeName: Enums_1.ControlTypes.SubmitButton, controlType: SubmitButton_1.SubmitButton },
            { typeName: Enums_1.ControlTypes.CancelButton, controlType: CancelButton_1.CancelButton },
            { typeName: Enums_1.ControlTypes.CustomButton, controlType: CustomButton_1.CustomButton },
            { typeName: Enums_1.ControlTypes.Checkbox, controlType: FormCheckBox_1.FormCheckBox },
            { typeName: Enums_1.ControlTypes.Textbox, controlType: FormTextInput_1.FormTextInput },
            { typeName: Enums_1.ControlTypes.DatePicker, controlType: FormDatePicker_1.FormDatePicker },
            { typeName: Enums_1.ControlTypes.DropDown, controlType: FormDropdown_1.FormDropdown },
            { typeName: Enums_1.ControlTypes.CascadingDropDown, controlType: FormCascader_1.FormCascader },
            { typeName: Enums_1.ControlTypes.ComboBox, controlType: FormComboBox_1.FormComboBox },
            { typeName: Enums_1.ControlTypes.ChoiceGroup, controlType: FormChoiceGroup_1.FormChoiceGroup },
            { typeName: Enums_1.ControlTypes.Toggle, controlType: FormToggle_1.FormToggle },
            { typeName: Enums_1.ControlTypes.RichtTex, controlType: FormRichTextInput_1.FormRichTextInput },
            { typeName: Enums_1.ControlTypes.Rating, controlType: FormRating_1.FormRating },
            { typeName: Enums_1.ControlTypes.MaskedTextbox, controlType: FormMaskedTextInput_1.FormMaskedTextInput },
            { typeName: Enums_1.ControlTypes.SpinButton, controlType: FormSpinButton_1.FormSpinButton },
            { typeName: Enums_1.ControlTypes.Slider, controlType: FormSlider_1.FormSlider },
            { typeName: Enums_1.ControlTypes.PeoplePicker, controlType: FormPeoplePicker_1.FormPeoplePicker },
    ...
    */
    FormInputs.prototype.getStandartControls = function () {
